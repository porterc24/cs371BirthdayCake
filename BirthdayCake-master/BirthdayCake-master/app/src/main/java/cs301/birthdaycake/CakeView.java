...
public class CakeView extends SurfaceView {
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        for (int i = 1; i<= this.cake.candleCount;  i++) {
            float location = cakeLeft + (i * cakeWidth) / (this.cake.candleCount + 1);
            location = location - candleWidth/ this.cake.candleCount;
